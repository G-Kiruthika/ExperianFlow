...
/**
 * HomePage class for Experian Loan Calculator automation.
 * Handles navigation from homepage to loan calculator page.
 * Traceable to test cases: Navigation and loan calculator access.
 */
public class HomePage {
    ...
    /**
     * Clicks the Loans navigation button.
     */
    ...
    /**
     * Navigates to the Personal Loan Calculator using mouse hover and click.
     */
