...
/**
 * LoanCalculator class encapsulates loan calculation actions and verifications.
 * Test Case Coverage: Input validation, calculation, error handling
 */
public class LoanCalculator {
    ...
    /**
     * Verifies and returns the result text after calculation.
     * @return Result text
     */
