...
/**
 * LoanCalculator class for Experian Loan Calculator automation.
 * Handles input actions and result verification on the loan calculator page.
 * Traceable to test cases: Loan calculation and result validation.
 */
public class LoanCalculator {
     ...
     * @param amount Loan amount as String
     */
     ...
     * @param rate Interest rate as String
     */
     ...
     * @param term Loan term as String
     */
     ...
     * @return Result text after calculation
     */
